...
export default function sitemap(): MetadataRoute.Sitemap {
  return [{ url: baseUrl, lastModified: new Date(), priority: 1 }, { url: `${baseUrl}/services`, lastModified: new Date(), priority: 0.9 }, ...slugs.map((slug) => ({ url: `${baseUrl}/services/${slug}`, lastModified: new Date() }))]
}
